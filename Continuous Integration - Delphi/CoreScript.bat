...
:: Calling main function of bat file:: Show some default characteres to fill screen
...
FOR /F "usebackq tokens=* eol=#" %%F in ("%os_PACKAGES:"=%") do (
    ...
    :: Finally delete config file created to compile package
    del /Q /S "!PackagePath!!PackageName!.cfg"
)
